...
export class GeneratorService {
  ...
  add(value:string):Observable<any>{
    let serverurl = this.url+"/tinyNet/device/generator/add";
    let data = {
      "generator":value,
  ...
  list(pi:Number,ps:Number,val:string):Observable<any>{
    let serverurl = this.url+"/tinyNet/device/generator/list";
    let data = {
      "ps":ps,
      "pi":pi,
      "val":val,
  ...
  select(id:Number):Observable<any>{
    let serverurl = this.url+"/tinyNet/device/generator/select"
    let data = {
      "id":id,
      "token":this.api.getCookie("token")
    }
  ...
  update(value:string):Observable<any>{
    let serverurl = this.url+"/tinyNet/device/generator/update"
    let data = {
      "generator":value,
      "token":this.api.getCookie("token")
    }
  ...
  delete(id:Number):Observable<any>{
    let serverurl = this.url+"/tinyNet/device/generator/delete";
    let data = {
      "id":id,
      "token":this.api.getCookie("token")
    }
