...
@Component({
  selector: 'app-network-select-waste-heat-boiler',
  templateUrl: './waste-heat-boiler.component.html',
...
export class NetworkSelectWasteHeatBoilerComponent implements OnInit {
