...
@Component({
  selector: 'app-network-select-centrifugal-electricitychiller',
  templateUrl: './centrifugal-electricitychiller.component.html',
  styleUrls:['../modal.component.css']
})


export class NetworkSelectCentrifugalElectricitychillerComponent implements OnInit {
