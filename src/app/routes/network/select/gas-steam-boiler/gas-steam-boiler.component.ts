...
@Component({
  selector: 'app-network-select-gas-steam-boiler',
  templateUrl: './gas-steam-boiler.component.html',
...
export class NetworkSelectGasSteamBoilerComponent implements OnInit {
