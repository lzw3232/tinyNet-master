...
@Component({
  selector: 'app-network-select-heat',
  templateUrl: './heat.component.html',
  styleUrls: ['./heat.component.css']
})

export class NetworkSelectHeatComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      for (var i = 0; i < 24; i++) {
        var tt2 = {"time": i, "load": this.result_data.load[i].vHeatWaterLoad,};
        sourceData.push(tt2);
      }
