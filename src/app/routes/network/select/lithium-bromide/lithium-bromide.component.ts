...
@Component({
  selector: 'app-network-select-lithium-bromide',
  templateUrl: './lithium-bromide.component.html',
...
export class NetworkSelectLithiumBromideComponent implements OnInit {
