...
@Component({
  selector: 'app-network-select-electric-boiler',
  templateUrl: './electric-boiler.component.html',
...
export class NetworkSelectElectricBoilerComponent implements OnInit {
