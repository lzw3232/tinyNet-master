...
@Component({
  selector: 'app-network-select-screw-electricitychiller',
  templateUrl: './screw-electricitychiller.component.html',
...
export class NetworkSelectScrewElectricitychillerComponent implements OnInit {
