...
@Component({
  selector: 'app-network-select-electricitychiller',
  templateUrl: './electricitychiller.component.html',
...
export class NetworkSelectElectricitychillerComponent implements OnInit {
