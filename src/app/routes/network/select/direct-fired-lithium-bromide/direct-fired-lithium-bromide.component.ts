...
@Component({
  selector: 'app-network-select-direct-fired-lithium-bromide',
  templateUrl: './direct-fired-lithium-bromide.component.html',
...
export class NetworkSelectDirectFiredLithiumBromideComponent implements OnInit {
