...
@Component({
  selector: 'app-network-select-solar',
  templateUrl: './solar.component.html',
  styleUrls: ['./solar.component.css']
})

export class NetworkSelectSolarComponent implements OnInit, AfterViewInit {
  ...
  chart_title_b = {text: '光照强度', textStyle: {fill: '#515151'}};
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      for (var i = 0; i < 24; i++) {
        var tt2 = {"time": i, "load": this.result_data.load[i].vCoolLoad,};
        sourceData.push(tt2);
      }
