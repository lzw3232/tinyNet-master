...
@Component({
  selector: 'app-network-select-steam',
  templateUrl: './steam.component.html',
  styleUrls: ['./steam.component.css']
})

export class NetworkSelectSteamComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      for (var i = 0; i < 24; i++) {
        var tt2 = {"time": i, "load": this.result_data.load[i].vSteamLoad,};
        sourceData.push(tt2);
      }
