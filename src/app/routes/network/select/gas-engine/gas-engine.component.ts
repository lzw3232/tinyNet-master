...
@Component({
  selector: 'app-network-select-gas-engine',
  templateUrl: './gas-engine.component.html',
...
export class NetworkSelectGasEngineComponent implements OnInit {
  @Input() public title;
  @Input() public result;
  forceFit = true; // 宽度自适应
  height = 400;
  ...
  columns: STColumn[] = [
    ...
    { title: '冷却水电比', type: 'number', index: 'coWaterPowerRatio' },
    { title: '烟气电比', type: 'number', index: 'gasEleRatio' },
