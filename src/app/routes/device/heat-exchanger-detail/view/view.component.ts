...
@Component({
  selector: 'app-device-plate-heat-detail-view',
  templateUrl: './view.component.html',
})
export class HeatExchangerDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"heat_exchanger").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
    ...
    //     this.i = res;
    //     const sourceData: any[] = [
    //       {x : this.i.numberOrCapacityOrCapacity1, 初建成本 : this.i.capitalCurve1, 替换成本 : this.i.replacementCost1, 运维成本 : this.i.maintainCost1},
    //       {x : this.i.numberOrCapacityOrCapacity2, 初建成本 : this.i.capitalCurve2, 替换成本 : this.i.replacementCost2, 运维成本 : this.i.maintainCost2},
    //       {x : this.i.numberOrCapacityOrCapacity3, 初建成本 : this.i.capitalCurve3, 替换成本 : this.i.replacementCost3, 运维成本 : this.i.maintainCost3},
    //       {x : this.i.numberOrCapacityOrCapacity4, 初建成本 : this.i.capitalCurve4, 替换成本 : this.i.replacementCost4, 运维成本 : this.i.maintainCost4},
    //     ];
    //
    //     const dv = new DataSet.View().source(sourceData);
    //     dv.transform({
