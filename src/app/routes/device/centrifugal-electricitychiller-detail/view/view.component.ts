...
@Component({
  selector: 'app-device-centrifugal_electricitychiller-detail-view',
  templateUrl: './view.component.html',
})
export class CentrifugalElectricitychillerDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"centrifugal_electricitychiller").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
