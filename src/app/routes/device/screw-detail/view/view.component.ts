...
@Component({
  selector: 'app-device-screw-detail-view',
  templateUrl: './view.component.html',
})
export class ScrewDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"screw").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
