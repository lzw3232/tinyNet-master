...
@Component({
  selector: 'app-device-electricitychiller-detail-view',
  templateUrl: './view.component.html',
})
export class ElectricitychillerDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"electricitychiller").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
