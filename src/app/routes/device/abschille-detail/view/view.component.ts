...
@Component({
  selector: 'app-device-abschille-detail-view',
  templateUrl: './view.component.html',
})
export class  AbschilleDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"abschille").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
