...
@Component({
  selector: 'app-device-hydro-turbine-detail-view',
  templateUrl: './view.component.html',
})
export class HydroTurbineDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"hydro_turbine").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
