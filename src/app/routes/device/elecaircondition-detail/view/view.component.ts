...
@Component({
  selector: 'app-device-elecaircondition-detail-view',
  templateUrl: './view.component.html',
})
export class ElecairconditionDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"elecaircondition").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
