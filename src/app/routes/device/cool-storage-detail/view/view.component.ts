...
@Component({
  selector: 'app-device-cool-storage-detail-view',
  templateUrl: './view.component.html',
})
export class CoolStorageDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"cool_storage").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
