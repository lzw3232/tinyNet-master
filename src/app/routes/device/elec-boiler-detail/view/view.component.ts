...
@Component({
  selector: 'app-device-elec-boiler-detail-view',
  templateUrl: './view.component.html',
})
export class ElecBoilerDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"elec_boiler").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
