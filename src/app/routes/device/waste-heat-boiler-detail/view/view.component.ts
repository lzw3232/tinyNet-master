...
@Component({
  selector: 'app-device-waste-heat-boiler-detail-view',
  templateUrl: './view.component.html',
})
export class WasteHeatBoilerDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"waste_heat_boiler").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
