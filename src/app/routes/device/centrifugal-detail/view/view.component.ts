...
@Component({
  selector: 'app-device-centrifugal-detail-view',
  templateUrl: './view.component.html',
})
export class CentrifugalDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"centrifugal").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
