...
@Component({
  selector: 'app-device-nuclear-detail-view',
  templateUrl: './view.component.html',
})
export class NuclearDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"nuclear").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
        this.i = res["data"]["data"]["data"];
        const sourceData: any[] = [
          {x : this.i.capacity1, 初建成本 : this.i.fBuildCost1, 更新成本 : this.i.rBuildCost1, 运维成本 : this.i.operCost1},
          {x : this.i.capacity2, 初建成本 : this.i.fBuildCost2, 更新成本 : this.i.rBuildCost2, 运维成本 : this.i.operCost2},
          {x : this.i.capacity3, 初建成本 : this.i.fBuildCost3, 更新成本 : this.i.rBuildCost3, 运维成本 : this.i.operCost3},
          {x : this.i.capacity4, 初建成本 : this.i.fBuildCost4, 更新成本 : this.i.rBuildCost4, 运维成本 : this.i.operCost4},
        ];
