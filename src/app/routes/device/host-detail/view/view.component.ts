...
// @Component({
//   selector: 'app-device-host-detail-view',
//   templateUrl: './view.component.html',
// })
// export class HostDetailViewComponent implements OnInit {
...
export class HostDetailViewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"host").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
