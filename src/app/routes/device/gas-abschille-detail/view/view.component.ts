...
@Component({
  selector: 'app-device-gas-abschille-detail-view',
  templateUrl: './view.component.html',
})
export class GasAbschilleDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"gas_abschille").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
