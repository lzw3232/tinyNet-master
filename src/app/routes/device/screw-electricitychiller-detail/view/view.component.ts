...
@Component({
  selector: 'app-device-screw-electricitychiller-detail-view',
  templateUrl: './view.component.html',
})
export class ScrewElectricitychillerDetailViewComponent implements OnInit {
  record: any = {};
  i: any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.i);
    this.devicesService.select(this.record.id,"screw_electricitychiller").subscribe((res)=>{
      console.log(res);
      if(res["errno"]=="0"){
